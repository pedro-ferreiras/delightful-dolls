...
Doll.create!(name: "Barbie", condition: "good", image: "https://res.cloudinary.com/dug5dmhjs/image/upload/v1661340401/production/barbie_yh9z5r.jpg", description: "A classic.", cursed: false, user_id: user2.id)
